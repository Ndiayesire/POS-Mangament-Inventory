...
<html lang="en">
   ...
   <body>
      ...
      <main>
         <div id="details" class="clearfix">
                  ...
                  <tbody>
                     <tr>
                        <td>
                           ...
                           <div><strong>Téléhone:</strong> {{$quote['client_phone']}}</div>
            ...
            <div id="invoice">
               <table  class="table-sm">
                  <thead>
                     <tr>
                        <th class="desc">Infos Quincaillerie</th>
                     </tr>
                  </thead>
                  <tbody>
                     <tr>
                        <td>
                           ...
                           <div><strong>Telephone:</strong>  {{$setting['CompanyPhone']}}</div>
         ...
         <div id="signature">Cachet et Signature</div>
      </main>
   </body>
</html>
